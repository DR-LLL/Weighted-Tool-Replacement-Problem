...
def plot_comparison(log_scale=False):
    ...
    plt.plot([i+1 for i in range(len(sorted_tests[fastest_algorithm]))], sorted_tests[fastest_algorithm], 
             label=algorithm_names[fastest_algorithm_index], color="#1E90FF", linestyle='-', linewidth=2.2)
